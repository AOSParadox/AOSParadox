...
function extract() {
	...
	git checkout -b backup/09042016/unified-8974-par-6.0
	git push aosparadox backup/09042016/unified-8974-par-6.0
	git reset --hard caf/LA.BF.1.1.3_rb1.12
	git branch -D unified-8974-par-6.0
	git checkout -b unified-8974-par-6.0
	git branch -D backup/09042016/unified-8974-par-6.0
	cd /home/louis/WORK/AOSPARADOX_BACON/
    done
}
